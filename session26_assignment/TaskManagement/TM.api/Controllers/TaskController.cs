...
namespace TM.api.Controllers
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddTask([FromBody] ProjectTaskDTO newTask)
        {
            ProjectTask _newTask = new ProjectTask
            {
             ...
             await _taskService.AddTask(_newTask);
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateTask(int id, [FromBody] ProjectTaskDTO updatedTask)
        {
            ...
            await _taskService.UpdateTask(existingProject);
            return NoContent();
        }
